        ...
        {gameState?.type === 'selection' && (
          <div className="submenu-container">
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => setGameState({ type: 'board_GO_FISH' })} className="submenu-btn">
                🐟 Go Fish
              </button>
              <button onClick={() => setGameState({ type: 'board_SIMPLE_PUZZLE' })} className="submenu-btn">
                🧩 Simple Puzzle
              </button>
              <button onClick={() => setGameState({ type: 'board_COLOR_MATCHING' })} className="submenu-btn">
                🎨 Color Match
              </button>
              <button onClick={() => setGameState({ type: 'board_PATTERN_BUILDER' })} className="submenu-btn">
                🔷 Pattern Builder
              </button>
        ...
        {constitutionMenuState?.type === 'historical-events' && (
          <div className="submenu-container">
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => handleQuickMessage('tell me about 9/11')} className="submenu-btn">
                🏢 September 11 (2001)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the first Black president')} className="submenu-btn">
                🎖️ First Black President (2009)
              </button>
