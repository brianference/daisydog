        ...
        {constitutionMenuState?.type === 'historical-events' && (
          <div className="submenu-container">
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => handleQuickMessage('tell me about the Moon landing')} className="submenu-btn">
                🌙 Moon Landing (1969)
              </button>
        ...
        {constitutionMenuState?.type === 'all-presidents' && (
          <div className="submenu-container" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => handleQuickMessage('tell me about James Madison')} className="submenu-btn">
                4. James Madison (1809-1817)
              </button>
              <button onClick={() => handleQuickMessage('tell me about James Monroe')} className="submenu-btn">
                5. James Monroe (1817-1825)
              </button>
              <button onClick={() => handleQuickMessage('tell me about John Quincy Adams')} className="submenu-btn">
                6. John Quincy Adams (1825-1829)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Andrew Jackson')} className="submenu-btn">
                7. Andrew Jackson (1829-1837)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Martin Van Buren')} className="submenu-btn">
                8. Martin Van Buren (1837-1841)
              </button>
              <button onClick={() => handleQuickMessage('tell me about William Henry Harrison')} className="submenu-btn">
                9. William Henry Harrison (1841)
              </button>
              <button onClick={() => handleQuickMessage('tell me about John Tyler')} className="submenu-btn">
                10. John Tyler (1841-1845)
              </button>
              <button onClick={() => handleQuickMessage('tell me about James K. Polk')} className="submenu-btn">
                11. James K. Polk (1845-1849)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Zachary Taylor')} className="submenu-btn">
                12. Zachary Taylor (1849-1850)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Millard Fillmore')} className="submenu-btn">
                13. Millard Fillmore (1850-1853)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Franklin Pierce')} className="submenu-btn">
                14. Franklin Pierce (1853-1857)
              </button>
              <button onClick={() => handleQuickMessage('tell me about James Buchanan')} className="submenu-btn">
                15. James Buchanan (1857-1861)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Abraham Lincoln')} className="submenu-btn">
                16. Abraham Lincoln (1861-1865)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Andrew Johnson')} className="submenu-btn">
                17. Andrew Johnson (1865-1869)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Ulysses S. Grant')} className="submenu-btn">
                18. Ulysses S. Grant (1869-1877)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Rutherford B. Hayes')} className="submenu-btn">
                19. Rutherford B. Hayes (1877-1881)
              </button>
              <button onClick={() => handleQuickMessage('tell me about James A. Garfield')} className="submenu-btn">
                20. James A. Garfield (1881)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Chester A. Arthur')} className="submenu-btn">
                21. Chester A. Arthur (1881-1885)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Grover Cleveland')} className="submenu-btn">
                22. Grover Cleveland (1885-1889)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Benjamin Harrison')} className="submenu-btn">
                23. Benjamin Harrison (1889-1893)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Grover Cleveland')} className="submenu-btn">
                24. Grover Cleveland (1893-1897)
              </button>
              <button onClick={() => handleQuickMessage('tell me about William McKinley')} className="submenu-btn">
                25. William McKinley (1897-1901)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Theodore Roosevelt')} className="submenu-btn">
                26. Theodore Roosevelt (1901-1909)
              </button>
              <button onClick={() => handleQuickMessage('tell me about William Howard Taft')} className="submenu-btn">
                27. William Howard Taft (1909-1913)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Woodrow Wilson')} className="submenu-btn">
                28. Woodrow Wilson (1913-1921)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Warren G. Harding')} className="submenu-btn">
                29. Warren G. Harding (1921-1923)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Calvin Coolidge')} className="submenu-btn">
                30. Calvin Coolidge (1923-1929)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Herbert Hoover')} className="submenu-btn">
                31. Herbert Hoover (1929-1933)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Franklin D. Roosevelt')} className="submenu-btn">
                32. Franklin D. Roosevelt (1933-1945)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Harry S. Truman')} className="submenu-btn">
                33. Harry S. Truman (1945-1953)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Dwight D. Eisenhower')} className="submenu-btn">
                34. Dwight D. Eisenhower (1953-1961)
              </button>
              <button onClick={() => handleQuickMessage('tell me about John F. Kennedy')} className="submenu-btn">
                35. John F. Kennedy (1961-1963)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Lyndon B. Johnson')} className="submenu-btn">
                36. Lyndon B. Johnson (1963-1969)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Richard Nixon')} className="submenu-btn">
                37. Richard Nixon (1969-1974)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Gerald Ford')} className="submenu-btn">
                38. Gerald Ford (1974-1977)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Jimmy Carter')} className="submenu-btn">
                39. Jimmy Carter (1977-1981)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Ronald Reagan')} className="submenu-btn">
                40. Ronald Reagan (1981-1989)
              </button>
              <button onClick={() => handleQuickMessage('tell me about George H.W. Bush')} className="submenu-btn">
                41. George H.W. Bush (1989-1993)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Bill Clinton')} className="submenu-btn">
                42. Bill Clinton (1993-2001)
              </button>
              <button onClick={() => handleQuickMessage('tell me about George W. Bush')} className="submenu-btn">
                43. George W. Bush (2001-2009)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Barack Obama')} className="submenu-btn">
                44. Barack Obama (2009-2017)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Donald Trump')} className="submenu-btn">
                45. Donald Trump (2017-2021)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Joe Biden')} className="submenu-btn">
