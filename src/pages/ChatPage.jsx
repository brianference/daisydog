      ...
      <div className="input-container">
        ...
        {activeGameActions && activeGameActions.length > 0 ? (
          ...
          <div className="quick-actions-compact">
            <button 
              onClick={() => {
                setGameState({ type: 'board_MEMORY_MATCH' });
              }}
              className="quick-btn"
              data-tooltip="Memory Match"
            >
              🃏
            </button>
            <button 
              onClick={() => {
                setGameState({ type: 'board_TIC_TAC_TOE' });
              }}
              className="quick-btn"
              data-tooltip="Tic-Tac-Toe"
            >
              ❌⭕
            </button>
            <button 
              onClick={() => {
                setGameState({ type: 'board_CONNECT_FOUR' });
              }}
              className="quick-btn"
              data-tooltip="Connect Four"
            >
              🔴🟡
            </button>
            <button 
