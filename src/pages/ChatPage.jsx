...
import LessonsComponent from '../components/LessonsComponent.jsx'
import './ChatPage.css'
...
const ChatPage = () => {
  ...
  const [gameKey, setGameKey] = useState(0) // Unique key to force game reset
  ...
  const renderBoardGame = () => {
    const gameProps = {
      ...
      gameKey // Pass gameKey to force component re-mount on restart
    };
  ...
  return (
    <div className="chat-page">
      ...
      <div className="input-container">
        ...
        {gameState?.type === 'selection' && (
          <div className="submenu-container">
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => setGameState({ type: 'board_CHECKERS' })} className="submenu-btn">
                ♟️ Checkers
              </button>
              <button onClick={() => setGameState({ type: 'board_CONNECT_FOUR' })} className="submenu-btn">
                🔴🟡 Connect Four
              </button>
              <button onClick={() => setGameState({ type: 'board_WORD_SCRAMBLE' })} className="submenu-btn">
                🔤 Word Scramble
              </button>
              <button onClick={() => setGameState({ type: 'board_SIMPLE_PUZZLE' })} className="submenu-btn">
                🧩 Puzzle Builder
              </button>
        ...
        {constitutionMenuState?.type === 'selection' && (
          <div className="submenu-container">
            ...
            <div className="submenu-buttons">
              ...
              <button onClick={() => setConstitutionMenuState({ type: 'history-of-america' })} className="submenu-btn">
                🏛️ History of America
              </button>
        ...
        {constitutionMenuState?.type === 'history-of-america' && (
          <div className="submenu-container">
            <h4>🏛️ History of America</h4>
            <div className="submenu-buttons">
              <button onClick={() => setConstitutionMenuState({ type: 'historical-events' })} className="submenu-btn">
                📅 Key Moments
              </button>
              <button onClick={() => setConstitutionMenuState({ type: 'all-presidents' })} className="submenu-btn">
                🎩 All Presidents
              </button>
              <button onClick={() => setConstitutionMenuState({ type: 'selection' })} className="submenu-btn close-btn">
                ⬅️ Back
        ...
        {constitutionMenuState?.type === 'historical-events' && (
          <div className="submenu-container">
            <h4>📅 Key Moments in American History</h4>
            <div className="submenu-buttons">
              <button onClick={() => handleQuickMessage('tell me about the Declaration of Independence')} className="submenu-btn">
                📜 Declaration (1776)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the American Revolution')} className="submenu-btn">
                ⚔️ Revolution (1775-1783)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Constitution')} className="submenu-btn">
                🇺🇸 Constitution (1787)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Louisiana Purchase')} className="submenu-btn">
                🗺️ Louisiana Purchase (1803)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Civil War')} className="submenu-btn">
                ⚔️ Civil War (1861-1865)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Emancipation Proclamation')} className="submenu-btn">
                ⛓️ Emancipation (1863)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the first airplane flight')} className="submenu-btn">
                ✈️ First Flight (1903)
              </button>
              <button onClick={() => handleQuickMessage('tell me about World War II')} className="submenu-btn">
                🌍 World War II (1941-1945)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Civil Rights Movement')} className="submenu-btn">
                ✊ Civil Rights (1954-1968)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Ronald Reagan and the Berlin Wall')} className="submenu-btn">
                🧱 Reagan & Berlin Wall (1987)
              </button>
              <button onClick={() => handleQuickMessage('tell me about the Republican Party founding')} className="submenu-btn">
                🐘 GOP Founded (1854)
              </button>
              <button onClick={() => handleQuickMessage('tell me about Abraham Lincoln freeing the slaves')} className="submenu-btn">
                ⛓️‍💥 Lincoln Frees Slaves (1863)
              </button>
              <button onClick={() => setConstitutionMenuState({ type: 'history-of-america' })} className="submenu-btn close-btn">
                ⬅️ Back
              </button>
            </div>
          </div>
        ...
        {constitutionMenuState?.type === 'all-presidents' && (
          <div className="submenu-container" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            <h4>🎩 All U.S. Presidents</h4>
            <select 
              onChange={(e) => { if(e.target.value) handleQuickMessage(e.target.value); }}
              className="president-dropdown"
              defaultValue=""
              style={{
                width: '100%',
                padding: '12px',
            ...
            >
              <option value="" disabled>Select a President...</option>
              <option value="tell me about George Washington">1. George Washington (1789-1797)</option>
              <option value="tell me about John Adams">2. John Adams (1797-1801)</option>
              <option value="tell me about Thomas Jefferson">3. Thomas Jefferson (1801-1809)</option>
              <option value="tell me about James Madison">4. James Madison (1809-1817)</option>
              <option value="tell me about James Monroe">5. James Monroe (1817-1825)</option>
              <option value="tell me about John Quincy Adams">6. John Quincy Adams (1825-1829)</option>
              <option value="tell me about Andrew Jackson">7. Andrew Jackson (1829-1837)</option>
              <option value="tell me about Martin Van Buren">8. Martin Van Buren (1837-1841)</option>
              <option value="tell me about William Henry Harrison">9. William Henry Harrison (1841)</option>
              <option value="tell me about John Tyler">10. John Tyler (1841-1845)</option>
              <option value="tell me about James K. Polk">11. James K. Polk (1845-1849)</option>
              <option value="tell me about Zachary Taylor">12. Zachary Taylor (1849-1850)</option>
              <option value="tell me about Millard Fillmore">13. Millard Fillmore (1850-1853)</option>
              <option value="tell me about Franklin Pierce">14. Franklin Pierce (1853-1857)</option>
              <option value="tell me about James Buchanan">15. James Buchanan (1857-1861)</option>
              <option value="tell me about Abraham Lincoln">16. Abraham Lincoln (1861-1865)</option>
              <option value="tell me about Andrew Johnson">17. Andrew Johnson (1865-1869)</option>
              <option value="tell me about Ulysses S. Grant">18. Ulysses S. Grant (1869-1877)</option>
              <option value="tell me about Rutherford B. Hayes">19. Rutherford B. Hayes (1877-1881)</option>
              <option value="tell me about James A. Garfield">20. James A. Garfield (1881)</option>
              <option value="tell me about Chester A. Arthur">21. Chester A. Arthur (1881-1885)</option>
              <option value="tell me about Grover Cleveland">22. Grover Cleveland (1885-1889)</option>
              <option value="tell me about Benjamin Harrison">23. Benjamin Harrison (1889-1893)</option>
              <option value="tell me about Grover Cleveland">24. Grover Cleveland (1893-1897)</option>
              <option value="tell me about William McKinley">25. William McKinley (1897-1901)</option>
              <option value="tell me about Theodore Roosevelt">26. Theodore Roosevelt (1901-1909)</option>
              <option value="tell me about William Howard Taft">27. William Howard Taft (1909-1913)</option>
              <option value="tell me about Woodrow Wilson">28. Woodrow Wilson (1913-1921)</option>
              <option value="tell me about Warren G. Harding">29. Warren G. Harding (1921-1923)</option>
              <option value="tell me about Calvin Coolidge">30. Calvin Coolidge (1923-1929)</option>
              <option value="tell me about Herbert Hoover">31. Herbert Hoover (1929-1933)</option>
              <option value="tell me about Franklin D. Roosevelt">32. Franklin D. Roosevelt (1933-1945)</option>
              <option value="tell me about Harry S. Truman">33. Harry S. Truman (1945-1953)</option>
              <option value="tell me about Dwight D. Eisenhower">34. Dwight D. Eisenhower (1953-1961)</option>
              <option value="tell me about John F. Kennedy">35. John F. Kennedy (1961-1963)</option>
              <option value="tell me about Lyndon B. Johnson">36. Lyndon B. Johnson (1963-1969)</option>
              <option value="tell me about Richard Nixon">37. Richard Nixon (1969-1974)</option>
              <option value="tell me about Gerald Ford">38. Gerald Ford (1974-1977)</option>
              <option value="tell me about Jimmy Carter">39. Jimmy Carter (1977-1981)</option>
              <option value="tell me about Ronald Reagan">40. Ronald Reagan (1981-1989)</option>
              <option value="tell me about George H.W. Bush">41. George H.W. Bush (1989-1993)</option>
              <option value="tell me about Bill Clinton">42. Bill Clinton (1993-2001)</option>
              <option value="tell me about George W. Bush">43. George W. Bush (2001-2009)</option>
              <option value="tell me about Barack Obama">44. Barack Obama (2009-2017)</option>
              <option value="tell me about Donald Trump">45. Donald Trump (2017-2021)</option>
              <option value="tell me about Joe Biden">46. Joe Biden (2021-2025)</option>
              <option value="tell me about Donald Trump">47. Donald Trump (2025-Present) ⭐ Current</option>
            </select>
            <button onClick={() => setConstitutionMenuState({ type: 'history-of-america' })} className="submenu-btn close-btn">
              ⬅️ Back
            </button>
        ...
        {showLessons && (
          <LessonsComponent
            childSessionId={childSessionService.getSessionId()}
